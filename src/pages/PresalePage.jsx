...
function PresalePage() {
    ...
    // After a confirmed on-chain tx, poll history until the new row appears (max 5Ã—)
    ...
    // Bidirectional USDT â†” HYK handlers
...
// â”€â”€ Effects â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Derived display values â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return (
        <div style={{ minHeight: "100vh", fontFamily: "'Pretendard Variable', 'Pretendard', sans-serif", color: "#F0F0FF" }} className={exiting ? "page-exit" : ""}>
            <style>{`
                                ...
                                {paymentTab === "USDT" && (() => {
                                    ...
                                    return (
                                        <>
                                            ...
                                            {/* â”€â”€ Step 1: Approve (no amount input) â”€â”€ */}
                                            {!isApproved && (
                                                <>
                                            ...
                                            {/* â”€â”€ Step 2: Amount inputs + Buy (only after approval) â”€â”€ */}
                                            {isApproved && (
                                                <>
                                            ...
                                            {displayedTx.slice(0, 50).map((tx, i) => {
                                                ...
                                                return (
                                                    <div key={tx.tx_hash || i} style={{
                                                        ...
                                                        {/* Row 1: token badge Â· wallet Â· time Â· bscscan link */}
