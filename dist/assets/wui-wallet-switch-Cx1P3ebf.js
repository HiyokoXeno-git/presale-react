import{h as e,i as t,l as n,o as r,p as i,r as a,s as o,t as s}from"./index-neiIvbWG.js";import{s as c}from"./wui-text-CMSia5uN.js";import{t as l}from"./if-defined-BLsUFslG.js";import"./wui-image-Bj7Ct5Oi.js";import"./wui-icon-box-C6PNq02c.js";var u=e`<svg width="86" height="96" fill="none">
  <path
...
`,m=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},h=class extends n{constructor(){super(...arguments),this.size=`md`,this.name=`uknown`,this.networkImagesBySize={sm:f,md:d,lg:u},this.selected=!1,this.round=!1}render(){let e={sm:`4`,md:`6`,lg:`10`};return this.round?(this.dataset.round=`true`,this.style.cssText=`
    ...
    `,i`${this.templateVisual()} ${this.svgTemplate()} `}svgTemplate(){return this.round?null:this.networkImagesBySize[this.size]}templateVisual(){return this.imageSrc?i`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:i`<wui-icon size="inherit" color="default" name="networkPlaceholder"></wui-icon>`}};h.styles=[r,p],m([c()],h.prototype,`size`,void 0),m([c()],h.prototype,`name`,void 0),m([c({type:Object})],h.prototype,`networkImagesBySize`,void 0),m([c()],h.prototype,`imageSrc`,void 0),m([c({type:Boolean})],h.prototype,`selected`,void 0),m([c({type:Boolean})],h.prototype,`round`,void 0),h=m([s(`wui-network-image`)],h);var g=o`
  :host {
    position: relative;
...
`,_=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},v=class extends n{constructor(){super(...arguments),this.size=`md`,this.name=``,this.installed=!1,this.badgeSize=`xs`}render(){let e=`1`;return this.size===`lg`?e=`4`:this.size===`md`?e=`2`:this.size===`sm`&&(e=`1`),this.style.cssText=`
   ...
   `,this.dataset.size=this.size,this.imageSrc&&(this.dataset.image=`true`),this.walletIcon&&(this.dataset.walletIcon=this.walletIcon),i`
    ...
    `}templateVisual(){return this.imageSrc?i`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:this.walletIcon?i`<wui-icon size="md" color="default" name=${this.walletIcon}></wui-icon>`:i`<wui-icon
      ...
      color="inherit"
      name="wallet"
    ></wui-icon>`}};v.styles=[r,g],_([c()],v.prototype,`size`,void 0),_([c()],v.prototype,`name`,void 0),_([c()],v.prototype,`imageSrc`,void 0),_([c()],v.prototype,`walletIcon`,void 0),_([c({type:Boolean})],v.prototype,`installed`,void 0),_([c()],v.prototype,`badgeSize`,void 0),v=_([s(`wui-wallet-image`)],v);var y=o`
  button {
    display: flex;
    align-items: center;
    height: 40px;
...
`,b=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},x=class extends n{constructor(){super(...arguments),this.address=``,this.profileName=``,this.alt=``,this.imageSrc=``,this.icon=void 0,this.iconSize=`md`,this.enableGreenCircle=!0,this.loading=!1,this.charsStart=4,this.charsEnd=6}render(){return i`
      <button>
    ...
    `}rightImageTemplate(){return i`<wui-icon name="chevronBottom" size="sm" color="default"></wui-icon>`}};x.styles=[r,t,y],b([c()],x.prototype,`address`,void 0),b([c()],x.prototype,`profileName`,void 0),b([c()],x.prototype,`alt`,void 0),b([c()],x.prototype,`imageSrc`,void 0),b([c()],x.prototype,`icon`,void 0),b([c()],x.prototype,`iconSize`,void 0),b([c({type:Boolean})],x.prototype,`enableGreenCircle`,void 0),b([c({type:Boolean})],x.prototype,`loading`,void 0),b([c({type:Number})],x.prototype,`charsStart`,void 0),b([c({type:Number})],x.prototype,`charsEnd`,void 0),x=b([s(`wui-wallet-switch`)],x);export{d as t};