import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./ModalController-O2N328fJ.js";import{L as c,l,n as u,o as d,p as f,s as p,t as m}from"./index-Df1v4LuN.js";import{o as h,s as g}from"./wui-text-rxXXfRC2.js";import{t as _}from"./if-defined-VLdgei-m.js";import"./wui-image-Com7vMnD.js";import"./wui-icon-box-1OOB9qEZ.js";import"./wui-shimmer-CiBdoRvo.js";import"./wui-link-Csr75OYs.js";import"./wui-icon-box-viD7fgCE.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=p`
  :host > wui-flex {
    display: flex;
