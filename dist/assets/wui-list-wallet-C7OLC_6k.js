import{C as e,y as t}from"./ModalController-O2N328fJ.js";import{i as n,l as r,o as i,p as a,s as o,t as s}from"./index-BGMDQQiV.js";import{o as c,s as l}from"./wui-text-B5fblsyz.js";import{t as u}from"./if-defined-CvdjCgKP.js";import"./wui-wallet-switch-CtQGwMLw.js";import"./wui-icon-box-CzEOVvX_.js";import{t as d}from"./HelpersUtil-BBIzNkPr.js";import"./w3m-onramp-providers-footer-DnUDSfAl.js";var f=o`
  :host {
    display: block;
  }
...
`,p=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},m=class extends r{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status=`hide`,this.view=t.state.view}firstUpdated(){this.status=d.hasFooter()?`show`:`hide`,this.unsubscribe.push(t.subscribeKey(`view`,e=>{this.view=e,this.status=d.hasFooter()?`show`:`hide`,this.status===`hide`&&document.documentElement.style.setProperty(`--apkt-footer-height`,`0px`)})),this.resizeObserver=new ResizeObserver(e=>{for(let t of e)if(t.target===this.getWrapper()){let e=`${t.contentRect.height}px`;document.documentElement.style.setProperty(`--apkt-footer-height`,e)}}),this.resizeObserver.observe(this.getWrapper())}render(){return a`
      <div class="container" status=${this.status}>${this.templatePageContainer()}</div>
    `}templatePageContainer(){return d.hasFooter()?a` ${this.templateFooter()}`:null}templateFooter(){switch(this.view){case`Networks`:return this.templateNetworksFooter();case`Connect`:case`ConnectWallets`:case`OnRampFiatSelect`:case`OnRampTokenSelect`:return a`<w3m-legal-footer></w3m-legal-footer>`;case`OnRampProviders`:return a`<w3m-onramp-providers-footer></w3m-onramp-providers-footer>`;default:return null}}templateNetworksFooter(){return a` <wui-flex
      class="footer-in"
      padding="3"
...
`,y=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},b=4,x=class extends r{constructor(){super(...arguments),this.walletImages=[]}render(){let e=this.walletImages.length<b;return a`${this.walletImages.slice(0,b).map(({src:e,walletName:t})=>a`
          <wui-wallet-image
            size="sm"
            imageSrc=${e}
            name=${u(t)}
          ></wui-wallet-image>
        `)}
    ${e?[...Array(b-this.walletImages.length)].map(()=>a` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};x.styles=[i,v],y([l({type:Array})],x.prototype,`walletImages`,void 0),x=y([s(`wui-all-wallets-image`)],x);var S=o`
  :host {
    width: 100%;
  }
...
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w={eip155:`ethereum`,solana:`solana`,bip122:`bitcoin`,polkadot:void 0,cosmos:void 0,sui:void 0,stacks:void 0,ton:`ton`,tron:`tron`},T=class extends r{constructor(){super(...arguments),this.walletImages=[],this.imageSrc=``,this.name=``,this.size=`md`,this.tabIdx=void 0,this.namespaces=[],this.disabled=!1,this.showAllWallets=!1,this.loading=!1,this.loadingSpinnerColor=`accent-100`}render(){return this.dataset.size=this.size,a`
      <button
    ...
    `}templateNamespaces(){return this.namespaces?.length?a`<wui-flex alignItems="center" gap="0">
        ${this.namespaces.map((e,t)=>a`<wui-flex
              alignItems="center"
