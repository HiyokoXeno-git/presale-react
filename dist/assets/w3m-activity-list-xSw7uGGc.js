import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./ModalController-O2N328fJ.js";import{L as c,l,n as u,o as d,p as f,s as p,t as m}from"./index-BiIIsqDt.js";import{o as h,s as g}from"./wui-text-DWORCshE.js";import{t as _}from"./if-defined-lfFIOmNN.js";import"./wui-image-BDY820I4.js";import"./wui-icon-box-D_RJryTX.js";import"./wui-shimmer-C1sqVEvV.js";import"./wui-link-BIOR6Tel.js";import"./wui-icon-box-i8NoNrJd.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=p`
  :host > wui-flex {
    display: flex;
