import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./ModalController-O2N328fJ.js";import{L as c,l,n as u,o as d,p as f,s as p,t as m}from"./index-COa1Av1I.js";import{o as h,s as g}from"./wui-text-DwK-FMLJ.js";import{t as _}from"./if-defined-CTZlcjyR.js";import"./wui-image-Z7syProb.js";import"./wui-icon-box-BAi1EEie.js";import"./wui-shimmer-B60VqONl.js";import"./wui-link-DvEm6VdC.js";import"./wui-icon-box-BU3Y2Q0c.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=p`
  :host > wui-flex {
    display: flex;
